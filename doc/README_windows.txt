...
Copyright (c) 2016 zebra Developers
...
Setup
-----
Unpack the files into a directory and run zebra-qt.exe.

zebra is the original zebra client and it builds the backbone of the network.
However, it downloads and stores the entire history of zebra transactions;

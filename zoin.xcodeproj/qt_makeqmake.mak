...
zoin.xcodeproj/project.pbxproj: zoin.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
		...
		/usr/local/Qt4.8/mkspecs/features/dbusinterfaces.prf \
		/usr/local/Qt4.8/mkspecs/features/dbusadaptors.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_DBUS=1 -o zoin.xcodeproj/project.pbxproj zoin.pro

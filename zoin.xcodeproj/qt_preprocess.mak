...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 8? 17 19:16:58 2017
# Project:  zoin.pro
# Template: app
# Command: /usr/bin/qmake USE_QRCODE=1 USE_UPNP=1 USE_DBUS=1 -o zoin.xcodeproj/project.pbxproj zoin.pro
#############################################################################
...
YACC      = yacc
YACCFLAGS = -d
DEFINES       = -DQT_GUI -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DBOOST_THREAD_PROVIDES_GENERIC_SHARED_MUTEX_ON_WIN -D__NO_SYSTEM_INCLUDES -DUSE_QRCODE -DUSE_UPNP=1 -DMINIUPNP_STATICLIB -DUSE_DBUS -DUSE_IPV6=1 -DHAVE_BUILD_INFO -DMAC_OSX -DMSG_NOSIGNAL=0 -DQT_DBUS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB -DQT_SHARED
INCPATH       = -I/usr/local/Qt4.8/mkspecs/macx-xcode -I/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/usr/include/QtCore -I/Library/Frameworks/QtNetwork.framework/Versions/4/Headers -I/usr/include/QtNetwork -I/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/usr/include/QtGui -I/Library/Frameworks/QtDBus.framework/Versions/4/Headers -I/usr/include/QtDBus -I/usr/include -Isrc -Isrc/json -Isrc/qt -I/usr/local/Cellar/miniupnpc/2.0.20170509/include -Isrc/leveldb/include -Isrc/leveldb/helpers -I/usr/local/Cellar/boost/1.64.0_1/include -I/usr/local/Cellar/berkeley-db@4/4.8.30/include -I/usr/local/Cellar/openssl/1.0.2l/include -I/usr/local/Cellar/qrencode/3.4.4/include -Ibuild -Ibuild -I/usr/local/include -I/System/Library/Frameworks/CarbonCore.framework/Headers -F/Library/Frameworks
DEL_FILE  = rm -f
MOVE      = mv -f
...
/Users/hanyouhong/chain/zoin/src/leveldb/libleveldb.a: FORCE
	cd /Users/hanyouhong/chain/zoin/src/leveldb && CC=gcc CXX=g++ $(MAKE)
